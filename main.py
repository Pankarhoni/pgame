...
IDLE_ANIMATION_SPEED = 15  # Slower idle animation speed, especially when on a box
...
if not on_ground:
    ...
    # When idle, just use the current idle frame without changing the frame index
    ...
    # Draw Character
    screen.blit(current_frame, character_rect)
